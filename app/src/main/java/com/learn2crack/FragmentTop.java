...
public class FragmentTop extends AppCompatActivity {
    ...
    protected void loadLocation() {
        FragmentTopPermissionsDispatcher.getMyLocationWithCheck(this);
        FragmentTopPermissionsDispatcher.startLocationUpdatesWithCheck(this);
    }

    @Override
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        super.onRequestPermissionsResult(requestCode, permissions, grantResults);
        FragmentTopPermissionsDispatcher.onRequestPermissionsResult(this, requestCode, grantResults);
    }
        ...
        locationClient.getLastLocation()
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Log.d("FragmentTop", "Error trying to get last GPS location");
                        e.printStackTrace();
                    }
                });
    }
    ...
    protected void startLocationUpdates() {
        ...
        getFusedLocationProviderClient(this).requestLocationUpdates(mLocationRequest, new LocationCallback() {
                    ...
                    public void onLocationResult(LocationResult locationResult) {
                       ...
                       /* Intent listIntent = new Intent(FragmentTop.this, ListActivity.class);
